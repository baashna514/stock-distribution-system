        ...
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="{{route('admin-stock.add-category')}}">
                                <span class="pcoded-mtext">Add Category</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-stock.list-category')}}">
                        ...
                        <li class="">
                            <a href="{{route('admin-product.list-product')}}">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="{{route('admin-customer.add-customer')}}">
                                <span class="pcoded-mtext">Add Customer</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-customer.requests-customer')}}">
                                <span class="pcoded-mtext">Approval Requests</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-customer.list-customer')}}">
                                <span class="pcoded-mtext">Customer List</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-customer.customer-credentials')}}">
                                <span class="pcoded-mtext">Customer Credentials</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <div class="pcoded-navigatio-lavel">Distributor</div>
                <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)">
                        <span class="pcoded-micon"><i class="feather icon-layers"></i></span>
                        <span class="pcoded-mtext">Distributor Management</span>
                        {{-- <span class="pcoded-badge label label-danger">100+</span> --}}
                    </a>
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="{{route('admin-distributor.add-distributor')}}">
                                <span class="pcoded-mtext">Add Distributor</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-distributor.requests-distributor')}}">
                                <span class="pcoded-mtext">Approval Requests</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-distributor.list-distributor')}}">
                                <span class="pcoded-mtext">Distributor List</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-distributor.distributor-credentials')}}">
                                <span class="pcoded-mtext">Distributor Credentials</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="pcoded-item pcoded-left-item">
                <li class="pcoded-hasmenu">
                    <a href="#">
                        <span class="pcoded-micon"><i class="feather icon-layers"></i></span>
                        <span class="pcoded-mtext">Admin Stock</span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="{{route('admin-stock.add-new-stock')}}">
                                <span class="pcoded-mtext">Add New Stock</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a href="{{route('admin-stock.list-stock')}}">
                                <span class="pcoded-mtext">List Stock</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="pcoded-hasmenu">
                    <a href="#">
                        <span class="pcoded-micon"><i class="feather icon-layers"></i></span>
                        <span class="pcoded-mtext">Distributor Stock</span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li class=" ">
                            <a href="alert.htm">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="">
                            <a href="{{route('admin-order.add-order')}}">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="">
                    <a href="public\extra-pages\landingpage\index.htm" target="_blank">
