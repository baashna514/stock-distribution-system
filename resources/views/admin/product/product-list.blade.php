                                                            ...
                                                            <table id="dom-table" class="table table-striped table-bordered nowrap table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$item->price}}</td>
                                                                        <td>
                                                                            <a href="{{route('admin-product.edit-product', ['id'=>$item->id])}}" class="btn btn-primary">Edit</a>
                                                                            <a href="{{route('admin-product.delete-product', ['id'=>$item->id])}}" class="btn btn-primary">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
