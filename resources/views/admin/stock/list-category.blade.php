...
<head>
    <title>SDS - Stock Distribution System | Category List Page</title>
                                                            ...
                                                            <table id="dom-table" class="table table-striped table-bordered nowrap table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{route('admin-stock.edit-category', ['id'=>$item->id])}}" class="btn btn-primary">Edit</a>
                                                                            <a id="btn-delete-category" onclick="myFunction()" href="{{route('admin-stock.delete-category', ['id'=>$item->id])}}" class="btn btn-primary">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
