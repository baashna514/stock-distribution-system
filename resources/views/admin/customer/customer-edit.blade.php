                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="">Customer Edit</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="{{route('admin-customer.update-customer', ['id'=>$customer->id])}}" method="post" class="j-pro" id="j-pro" novalidate="">
                                                                @csrf
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" value="{{$customer->name}}" id="name" name="name">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end name -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" value="{{$customer->phone}}" id="phone" name="phone">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end login -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" value="{{$customer->city}}" id="city" name="city">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end city -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="password" value="{{$customer->password}}" id="password" name="password">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end password --> --}}
