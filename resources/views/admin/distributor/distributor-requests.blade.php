                                                            ...
                                                            <table id="dom-table" class="table table-striped table-bordered nowrap table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$item->city}}</td>
                                                                        <td>
                                                                            <form action="{{route('admin-distributor.requests-distributors-change-status', ['id'=>$item->id])}}" method="POST" class="form-group">
                                                                                @csrf
                                                                                <select name="status" id="status" class="form-control" style="width:85px; height:19px;">
                                                                                    <option value="{{$item->status}}">{{$item->status}}</option>
                                                                                    <option value="approved">approved</option>
                                                                                </select>
                                                                                <button type="submit" class="btn btn-success" style="width:71px; margin-top:8px;">Change</button>
                                                                            </form>
                                                                        </td>
                                                                        <td>
                                                                            <a href="{{route('admin-distributor.edit-distributor', ['id'=>$item->id])}}" class="btn btn-primary">Edit</a>
                                                                            <a href="{{route('admin-distributor.delete-distributor', ['id'=>$item->id])}}" class="btn btn-primary">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
