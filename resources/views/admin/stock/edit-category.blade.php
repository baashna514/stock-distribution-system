...
<head>
    <title>SDS - Stock Distribution System | Edit Category Page</title>
...
<div id="pcoded" class="pcoded">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="">Catogory Edit</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="{{route('admin-stock.update-category', ['id'=>$category->id])}}" method="post" class="j-pro" id="j-pro" novalidate="">
                                                                @csrf
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div>
                                                                        <label class="j-label">Category Name</label>
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
    ...
    <script src="{{asset('public/pages/j-pro/js/custom/add-category.js')}}"></script>
</body>
