...
<head>
    <title>SDS - Stock Distribution System | Distributor Edit Page</title>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="">Distributor Edit</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="{{route('admin-distributor.update-distributor', ['id'=>$distributor->id])}}" method="post" class="j-pro" id="j-pro" novalidate="">
                                                                @csrf
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" value="{{$distributor->name}}" id="name" name="name">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end name -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="email" value="{{$distributor->email}}" id="email" name="email">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end email -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" value="{{$distributor->phone}}" id="phone" name="phone">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end login -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <textarea name="address" id="address" cols="30" rows="10">{{$distributor->address}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end address -->
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <input type="text" value="{{$distributor->city}}" id="city" name="city">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end city -->
