                                                            ...
                                                            <table id="dom-table" class="table table-striped table-bordered nowrap table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$item->city}}</td>
                                                                        <td>
                                                                            <form action="{{route('admin-customer.requests-customers-change-status', ['id'=>$item->id])}}" method="POST" class="form-group">
                                                                                @csrf
                                                                        ...
                                                                        <td>
                                                                            <a href="{{route('admin-customer.edit-customer', ['id'=>$item->id])}}" class="btn btn-primary">Edit</a>
                                                                            <a href="{{route('admin-customer.delete-customer', ['id'=>$item->id])}}" class="btn btn-primary">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
