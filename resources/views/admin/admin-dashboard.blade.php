...
<head>
    <title>SDS - Stock Distribution System | Admin Dashboard</title>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover table-borderless">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><img src="{{asset('public/images/widget/GERMANY.jpg')}}" alt="" class="img-fluid img-30"></td>
                                                                        <td>Germany</td>
                                                                        <td>3,562</td>
                                                                        <td class="text-right">56.23%</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img src="{{asset('public/images/widget/USA.jpg')}}" alt="" class="img-fluid img-30"></td>
                                                                        <td>USA</td>
                                                                        <td>2,650</td>
                                                                        <td class="text-right">25.23%</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img src="{{asset('public/images/widget/AUSTRALIA.jpg')}}" alt="" class="img-fluid img-30"></td>
                                                                        <td>Australia</td>
                                                                        <td>956</td>
                                                                        <td class="text-right">12.45%</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img src="{{asset('public/images/widget/UK.jpg')}}" alt="" class="img-fluid img-30"></td>
                                                                        <td>United Kingdom</td>
                                                                        <td>689</td>
                                                                        <td class="text-right">8.65%</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img src="{{asset('public/images/widget/BRAZIL.jpg')}}" alt="" class="img-fluid img-30"></td>
                                                                        <td>Brazil</td>
                                                                        <td>560</td>
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card social-network">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <img src="{{asset('public/images/widget/icon-1.png')}}" alt=" " class="img-responsive p-b-20">
                                                                <div class="row">
                                                                    <div class="col-5">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <img src="{{asset('public/images/widget/icon-2.png')}}" alt=" " class="img-responsive p-b-20">
                                                                <div class="row">
                                                                    <div class="col-5">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 m-t-0">
                                                                <img src="{{asset('public/images/widget/icon-3.png')}}" alt=" " class="img-responsive p-b-10 p-t-10">
                                                                <div class="row">
                                                                    <div class="col-5">
                                                            ...
                                                            <div class="col-sm-6 m-t-0">
                                                                <img src="{{asset('public/images/widget/icon-4.png')}}" alt=" " class="img-responsive p-b-10 p-t-10">
                                                                <div class="row">
                                                                    <div class="col-5">
                                                                        <p class="text-muted m-b-5">Tweets :</p>
                                                                    </div>
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="../files/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="../files/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="../files/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="../files/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="../files/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
//     document.addEventListener('mousewheel DOMMouseScroll', { passive: true });
//  });
</script>
</body>
