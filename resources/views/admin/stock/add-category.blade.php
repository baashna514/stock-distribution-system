...
<head>
    <title>SDS - Stock Distribution System | Add Category Page</title>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="">Catogory Add</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="{{route('admin-stock.add-category-action')}}" method="post" class="j-pro" id="j-pro" novalidate="">
                                                                @csrf
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div>
